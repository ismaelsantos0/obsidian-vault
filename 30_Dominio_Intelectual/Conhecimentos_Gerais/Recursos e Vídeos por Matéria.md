---
titulo: "Recursos e Vídeos por Matéria"
...
> [!NOTE]
> Todos os canais listados são **gratuitos no YouTube**. Nenhum exige assinatura para o conteúdo indicado.

---

## 🏦 AFO — Administração Financeira e Orçamentária

**Arquivo de estudo:** [[Administração Pública e AFO]]
...
### 📌 Playlist Ideal (ordem de estudo)
1. Introdução ao Orçamento Público (PPA, LDO, LOA)
2. Princípios Orçamentários
3. Ciclo da Despesa (Empenho → Liquidação → Pagamento)
4. Ciclo da Receita
5. Créditos Adicionais
6. LRF (RREO, RGF, Limites de pessoal)
...
### 📌 Playlist Ideal
1. Espécies Normativas (CF/88, Art. 59)
2. Quóruns: Maioria Simples vs Absoluta vs 3/5
3. Processo Legislativo Ordinário (PL → sanção/veto)
4. PEC e suas restrições
5. Medidas Provisórias
6. Legística — LC 95/98 (artigo, parágrafo, inciso, alínea)

---

## ⚖️ Direito Constitucional e Administrativo

**Arquivo de estudo:** [[Direito Constitucional e Administrativo]]
...
### 📌 Playlist Ideal
1. Princípios da Administração Pública (LIMPE — Art. 37 CF)
2. Administração Direta e Indireta
3. Serviços Públicos (Uti Universi × Uti Singuli, delegação)
4. Atos Administrativos (atributos, categorias, extinção)
5. Poderes Administrativos
6. Licitação (modalidades, Lei 8.666 e 14.133)
7. Controle da Administração (interno, externo, social)

---

## 💻 Informática

**Arquivo de estudo:** [[Informática Aplicada]]
...
### 📌 Playlist Ideal
1. Hardware e Software (conceitos básicos)
2. Windows 10/11 (atalhos, Lixeira, Explorer)
3. Microsoft Word (formatação, mala direta, controle de alterações)
4. Microsoft Excel (fórmulas, referência absoluta, filtros)
5. Microsoft PowerPoint
6. Google Workspace (Docs, Planilhas, Drive)
7. Internet (HTTP x HTTPS, cookies, cache, navegador)
8. E-mail (SMTP, POP3, IMAP)
9. Segurança da Informação (tipos de malware, firewall, backup)
10. Redes (LAN, WAN, Roteador, Switch, DNS, VPN)

---

## 🗺️ História e Geografia de Roraima

**Arquivo de estudo:** [[História e Geografia de Roraima]]
...
### 📌 Playlist Ideal
1. Formação histórica (1775 → 1943 → 1988)
2. Ciclos econômicos
3. Localização, fronteiras internacionais e municípios
4. Relevo (Serra do Pacaraima, Monte Roraima)
5. Hidrografia (Rio Branco, Rio Uraricoera)
6. Aspectos demográficos (população, IDH, terras indígenas)

---

## 📖 Língua Portuguesa

*(Arquivo de estudo dedicado a ser criado — enquanto isso, use o Caderno de Questões)*
...
### 📌 Playlist Ideal
1. Interpretação de Texto (a mais cobrada — faça primeiro)
2. Reescritura de Frases (mantendo o sentido)
3. Vozes Verbais (ativa, passiva, reflexiva)
4. Conectivos e Conjunções (o valor semântico de cada um)
...
### 📌 Playlist Ideal
1. Lógica Proposicional (→, ↔, ¬, ∧, ∨) e negação
2. Silogismo (Todo A é B, Nenhum A é B)
3. Sequências e Progressões (PA e PG)
