...
Este guia foi criado para simplificar os conceitos "nebulosos" usando analogias diretas e exemplos REAIS do estado de Roraima.
...
| :--- | :--- | :--- | :--- |
| **PEC (Emenda)** | **Regra de Ouro:** "Nunca venderemos a casa". | Difícil: 2 turnos e **3/5 dos votos**. | **NÃO.** A Assembleia manda sozinha. |
| **LC (Lei Complementar)** | **Manual de Engenharia:** Regras de manutenção pesada. | Médio: **Maioria Absoluta** (metade de TODOS os irmãos). | **SIM.** Pode sancionar ou vetar. |
| **LO (Lei Ordinária)** | **Rotina da Casa:** Horário do jantar, quem compra o pão. | Fácil: **Maioria Simples** (metade de quem está na sala). | **SIM.** Pode sancionar ou vetar. |
| **PR / PDL** | **Tarefas Internas:** Quem lava a louça, quem limpa o quarto. | Decisão rápida da Assembleia. | **NÃO.** O Governador não mexe aqui. |
...
## 🏗️ 3. O "Endereço" das Leis (Legística)
Se você precisar achar uma regra, siga o endereço:
1.  **Artigo:** O Prédio (Ideia principal).
2.  **Parágrafo (§):** O Andar (Um detalhe extra).
3.  **Inciso (I, II, III):** O Apartamento (Uma lista).
4.  **Alínea (a, b, c):** O Quarto (Detalhe do detalhe).

---

## 📺 4. Vídeos para Ver Agora (Simples e Curtos)
- [📺 Como Nasce uma Lei (Vídeo de 2 min)](https://www.youtube.com/watch?v=FjIuX2h92zE) - Perfeito para ver o fluxo.
- [📺 Processo Legislativo para Iniciantes (Didático)](https://www.youtube.com/watch?v=LqTjE1H9vDE) - Ótimo para entender as maiorias.
